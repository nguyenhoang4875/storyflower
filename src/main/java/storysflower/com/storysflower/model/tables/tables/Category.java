...
public class Category extends TableImpl<CategoryRecord> {
     ...
     */
    public final TableField<CategoryRecord, String> CATEGORY_NAME = createField("category_name", org.jooq.impl.SQLDataType.VARCHAR(30).nullable(false), this, "");
    /**
     * The column <code>public.category.category_meaning</code>.
     */
    public final TableField<CategoryRecord, String> CATEGORY_MEANING = createField("category_meaning", org.jooq.impl.SQLDataType.VARCHAR(10000), this, "");
